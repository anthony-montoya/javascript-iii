...
class Employee {
    ...
    makeWidget() {
        var str = this.first_name + " " + this.last_name + " Widget";
        return str;
    }
}
var person = new Employee("Anthony ", " Montoya", "yo@gmail.com", 23);
person.makeWidget();
...
*/
class Machine {
    constructor(widgets_made_count, wear_and_tear_count, needs_roboot) {
