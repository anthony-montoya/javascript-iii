...
let totalPopulation = populations.reduce((previous, element) => {
...
let bobsTotal = purchases.reduce((previous, element, index, array) => {
    if(array[index].owner === "Bob"){
        var total = previous + array[index].price;
